...
INFERENCE_COUNT = Counter(
    'ai_bg_predictions_total',
    'Total AI-background generations made',
    ['label', 'is_safe']
)

INFERENCE_DURATION = Histogram(
    'ai_bg_model_load_time_seconds',
    'AI background generation duration in seconds'
)
...
MODEL_LOAD_TIME = Gauge(
    'ai_bg_model_load_time_seconds',
    'Time taken to load the load the whole pipeline'
)

MODEL_LOADED = Gauge(
    'ai_bg_model_loaded',
    'Whether the whole pipeline is loaded (1=loaded, 0=not loaded)'
)
