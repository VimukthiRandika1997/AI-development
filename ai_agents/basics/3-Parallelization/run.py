"""A multi-agent system used to research and synthesize information 
on sustainable technology advancements."""

from google.adk.agents import LlmAgent, ParallelAgent, SequentialAgent
from google.adk.tools import google_search 
from google.adk import AgentExecutor
...
parallel_research_agent = ParallelAgent( 
    ...
    description="Runs multiple research agents in parallel to gather sinformation." 
)
