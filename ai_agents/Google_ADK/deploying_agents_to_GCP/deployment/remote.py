...
from adk_basic_bot.agent import root_agent
...
def create() -> None:
    ...
    remote_app = agent_engines.create(
        ...
        extra_packages=["./adk_basic_bot"], # Name of your agent ( package )
    )
...
def main(argv=None):
    ...
    if not project_id:
        ...
        raise ValueError("Missing required environment variable: GOOGLE_CLOUD_LOCATION")
    elif not bucket:
        raise ValueError("Missing required environment variable: GOOGLE_CLOUD_STAGING_BUCKET")
