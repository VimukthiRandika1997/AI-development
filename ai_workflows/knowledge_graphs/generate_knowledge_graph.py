...
# Load the ENV variables through .env file
load_dotenv()
...
allowed_nodes = ["Person", "Environment", "Object", "Light", "Surface"]
# Extract specific types of relationships
allowed_relationships = [
    ("Object", "ON", "Surface"),
    ("Person", "INTERACT", "Object"),
    ("Object", "IN_LOCATION", "Environment"),
...
async def extract_graph_data(text):
    ...
    graph_documents = await graph_transformer.aconvert_to_graph_documents(documents=documents)
...
def generate_knowledge_graph(text):
    ...
    graph_documents = asyncio.run(extract_graph_data(text=text))
    network = visualize_graph(graph_documents=graph_documents)
